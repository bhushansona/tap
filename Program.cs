...
Tap.Interfaces.ICalculateFare fareCalculator = new Tap.MiddleWare.FareCalculator();
var data = dataProcessor.ProcessData(csvPath);
...
// Register 
        case 1: 
            var profileToRegister = dataProcessor.GetDriverData(); 
 ...
 // Update 
        case 3: 
            var profileToUpdate = dataProcessor.GetDriverData(); 
 ...
 // Show Drivers 
        case 4: 
            ...
            dataProcessor.PrintData(allDrivers); 
            break;
 // Get Fare 
        case 5: 
            var cheaper = fareCalculator.GetCheapest(); 
            Console.WriteLine("Cheaper fare is: " + cheaper.Fare + " for " + cheaper.DriverName);
            break;
 // Show Fares 
        case 6: 
            var allFares = fareCalculator.ShowAll(); 
            dataProcessor.PrintFares(allFares); 
            break;
        case 7: 
            isContinue = false; 
            break;
